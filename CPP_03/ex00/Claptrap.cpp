...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/30 00:23:54 by repinat           #+#    #+#             */
/*   Updated: 2022/11/30 01:09:35 by repinat          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : Hit_points(10), 
Energy_points(10), Attack_damage(0)
{
	std::cout << "Default constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string _name) : Hit_points(10), 
Energy_points(10), Attack_damage(0)
{
...
ClapTrap::ClapTrap(ClapTrap const & src) : Hit_points(10), 
Energy_points(10), Attack_damage(0)
{
